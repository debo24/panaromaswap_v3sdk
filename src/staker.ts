import { BigintIsh, Token, validateAndParseAddress } from 'panaromaswap_sdkcore'
import { MethodParameters, toHex } from './utils/calldata'
import { defaultAbiCoder, Interface } from '@ethersproject/abi'
import IPanaromaswapV3Staker from 'panaromaswap_v3staker/artifacts/contracts/PanaromaswapV3Staker.sol/PanaromaswapV3Staker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(IPanaromaswapV3Staker.abi)
