...
import INonfungiblePositionManager from 'panaromaswap_v3periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
