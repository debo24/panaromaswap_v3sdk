...
import IPeripheryPaymentsWithFee from 'panaromaswap_v3periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'
