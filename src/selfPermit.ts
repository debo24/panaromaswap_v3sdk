import { BigintIsh, Token } from 'panaromaswap_sdkcore'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from 'panaromaswap_v3periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
