...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from 'panaromaswap_sdkcore'
...
import ISwapRouter from 'panaromaswap_v3periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the Panaromaswap V3 SwapRouter, and has static methods for helping execute trades.
 */
