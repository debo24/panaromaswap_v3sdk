...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from 'panaromaswap_sdkcore'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from 'panaromaswap_v3periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from 'panaromaswap_swaproutercontracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
...
/**
 * Represents the Panaromaswap V3 QuoterV1 contract with a method for returning the formatted
